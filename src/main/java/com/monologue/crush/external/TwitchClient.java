...
import com.monologue.crush.entity.ItemType;
...
public class TwitchClient {
    private static final String TOKEN = "Bearer 9plkcgxhch1ptqejy6ieug8zvbcedj";
    private static final String CLIENT_ID = "3px5ytf3eob7x23zvbyy2n1s1dnnw4";
